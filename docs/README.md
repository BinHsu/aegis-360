...
| Change gradual chapter proposals or visual-state features | `docs/experiments/skiing-gradual-chapter-blind-protocol-2026-09-06.md`, `docs/experiments/skiing-visual-state-features-v1-2026-09-06.md`, ADR 0010, then ADR 0005 |
...
| Resume nuisance-aware sparse story semantics | `docs/experiments/sparse-story-semantic-successor-v1-2026-09-07.md`, ADR 0010, then `docs/design/event-semantic-evidence.md` |
...
| Change numeric persistent story planning or transition costs | `docs/design/event-semantic-evidence.md`, ADR 0006, ADR 0010 |
| Resume typed continuous-onset planning | `docs/experiments/skiing-continuity-transition-v1-2026-08-24.md`, `docs/design/event-semantic-evidence.md`, then ADR 0010 |
