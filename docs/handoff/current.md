...
Branch: main
Baseline commit: c5bd10e
Remote status: spherical vertical-extent migration and checkpoint are ready to push
...
- Expected branch: `main`; content baseline is `c5bd10e`.
