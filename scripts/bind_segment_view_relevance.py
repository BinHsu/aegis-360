#!/usr/bin/env python3
"""Bind closed candidate observations to one exact story-segment packet."""
...
from aegis360.segment_view_relevance import build_segment_view_relevance  # noqa: E402
...
def main() -> int:
    ...
    document = build_segment_view_relevance(
