#!/usr/bin/env python3
"""Build one atomic bounded review packet from Event Timeline v2."""
...
from aegis360.multi_signal_review_packet import build_multi_signal_review_packet  # noqa: E402
...
def main() -> int:
    ...
    artifact = build_multi_signal_review_packet(
    ...
    print(json.dumps({"render_frame_count": sum(len(row["candidate_ids"]) for row in artifact["samples"])}, sort_keys=True))
    return 0
