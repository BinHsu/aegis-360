#!/usr/bin/env python3
"""Build one atomic story packet for an exact retained scene signal."""
...
def main() -> int:
    ...
    document = build_scene_boundary_story_packet(
        json.loads(timeline_raw), json.loads(grid_raw), event_id=args.event_id,
        signal_id=args.signal_id, timeline_sha256=hashlib.sha256(timeline_raw).hexdigest(),
