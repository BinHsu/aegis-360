...
def main() -> int:
    ...
    parser.add_argument("availability_json", type=Path); parser.add_argument("gain_json", type=Path)
    ...
    evidence_paths = (args.grid_json, args.roles_json, args.reactions_json, args.availability_json, args.gain_json, args.plan_json)
    ...
    gain = json.loads(args.gain_json.read_text())
