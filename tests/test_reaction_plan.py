...
class ReactionPlanTests(unittest.TestCase):
    def test_intersects_events_with_availability_and_returns_primary(self):
        ...
        availability = {"schema_version":"aegis360.live-scene-intervals.v1","source_id":"fixture","source_semantic_schema":"aegis360.semantic-detector-events.v2","policy":{},"intervals":[{"start_seconds":2,"end_seconds":6,"supporting_timestamp_count":8}],"privacy":{},"limitations":[]}
        ...
        self.assertEqual(result["transition_policy"], "hard_cut_only_when_reaction_onset_is_live_v2")
    ...
    def test_event_starting_before_live_scene_is_not_joined_mid_reaction(self):
        ...
        availability = {"schema_version":"aegis360.live-scene-intervals.v1","source_id":"fixture","source_semantic_schema":"aegis360.semantic-detector-events.v2","policy":{},"intervals":[{"start_seconds":4,"end_seconds":10,"supporting_timestamp_count":8}],"privacy":{},"limitations":[]}
        result = build_reaction_plan(grid, roles, reactions, availability, grid_sha256=checksum)
